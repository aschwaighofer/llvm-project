...
public:
  ...
  GlobalVariable *getAsyncFunctionPointer() const {
    return cast<GlobalVariable>(getArgOperand(AsyncFuncPtrArg)->stripPointerCasts());
  }
...
class LLVM_LIBRARY_VISIBILITY CoroAsyncContextDeallocInst : public IntrinsicInst {
